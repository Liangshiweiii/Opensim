...
class PeriodicTable                                                             ///  Stores the properties of all elements in the periodic table
{
 public:
    ...
    PeriodicTable(void)
    {
        ...
        temp.AtomicWeight = 294.;
        temp.MolarVolume  = -1.;

        Data.push_back(temp);
    }

    Element GetData(std::string Name)
    {
